...
public class MainAdapter extends RecyclerView.Adapter<MainAdapter.RecyclerViewAdapter> {
    ...
    @Override
    public MainAdapter.RecyclerViewAdapter onCreateViewHolder(@NonNull @org.jetbrains.annotations.NotNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(context).inflate(R.layout.item_note,parent,false);
        return new RecyclerViewAdapter(view , itemClickListener);
    }

    @Override
    public void onBindViewHolder(@NonNull @org.jetbrains.annotations.NotNull MainAdapter.RecyclerViewAdapter holder, int position) {
    ...
    public class RecyclerViewAdapter extends RecyclerView.ViewHolder implements View.OnClickListener{
        ...
        public RecyclerViewAdapter(@NonNull @NotNull View itemView, ItemClickListener itemClickListener) {
            super(itemView);
